...
pub type Aegis256<T> = Aegis256X<U1, T>;
pub type Aegis256X2<T> = Aegis256X<U2, T>;
pub type Aegis256X4<T> = Aegis256X<U4, T>;

pub type AegisMac256X<D, T> = AegisMac<State256X<D>, T>;

pub type AegisMac256<T> = AegisMac256X<U1, T>;
pub type AegisMac256X2<T> = AegisMac256X<U2, T>;
pub type AegisMac256X4<T> = AegisMac256X<U4, T>;
